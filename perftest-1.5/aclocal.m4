...
m4_include([config/aclocal_cache.m4])
m4_include([config/aclocal_cc.m4])
m4_include([config/aclocal_fc.m4])
m4_include([config/aclocal_make.m4])
m4_include([config/aclocal_mpi.m4])
m4_include([config/aclocal_util.m4])
