 ...
 */
MPIR_memcpy( void *restrict dest, const void *src, register int n )
{
  char *restrict d8 = (char *)dest;
...
switch (n & 0x7) {
    case 0:
	    ...
	    register MPIR_dbl64 *restrict d64;
	    register const MPIR_dbl64 *s64;
#ifdef HAVE_DISJOINT
#pragma disjoint (*d64,*s64)
#endif
     	    d64 = (MPIR_dbl64 *restrict)dest;
     	    s64 = (const MPIR_dbl64 *)src;
     	    n >>= 3;
	    DUFFCOPY8( d64, s64, n );
	    return;
    	    }
...
#endif
     	    d32 = (MPIR_int32 *restrict)dest;
     	    s32 = (const MPIR_int32 *)src;
     	    n >>= 2;
	    DUFFCOPY8( d32, s32, n );
	    return;
    	    }
